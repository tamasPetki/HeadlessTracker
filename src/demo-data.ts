...
// Five sample accounts — one per connector — so the demo tells the full
// multi-venue story (exchanges + EVM wallet + Solana wallet + prediction market).
// Addresses are obviously-sample, not real wallets.
